'use client'
import { AuthStatus, Cookies, Customer, IAuthLogoutResponse, LoginInput, SignUpInput, SignUpResponse, assertNotNullOrUndefined } from '@project/shared'
...
export function CustomerProvider({ children }: PropsWithChildren) {
  ...
  const [customer, setCustomer] = useLocalStorage('customer-data', {} as Customer)
